...
class Segmentation(Image):
        ...
        *,
        ...
        Args:
            ...
            interpolator (int): SimpleITK interpolator constant forwarded
                to ``rotate``.
                Only nearest neighbors should be used for binary segmentations.
        ...
        Returns:
            Segmentation: Reoriented segmentation matching ``new_direction``.
        """
        return Segmentation(
            super().reorient(
    ...
    def _flip(self, axis: int) -> Segmentation:
        ...
        Returns:
            Segmentation: Mirrored segmentation with the same spacing, size and metadata, and
                a direction cosine matrix of opposite determinant.
        """
        return Segmentation(
            super()._flip(axis=axis), name=self.name, segmentation_type=self.segmentation_type
        )
    ...
    def rotate(
        ...
        *,
        ...
        """Apply a 3D rotation to the segmentation and return the transformed copy.
        ...
        Returns:
            Segmentation: Rotated segmentation with updated direction and origin, and the
